...
/**
 * <p>agencyPersionExample complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�����ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
 * &lt;complexType name="agencyPersionExample"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "agencyPersionExample", propOrder = {
    "addr1",
    "addr2",
    "address",
    "areaId",
...
public class AgencyPersionExample {
